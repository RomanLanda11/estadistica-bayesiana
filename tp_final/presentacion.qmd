...
g1/g2/g3/plot_annotation(caption = "Gráfico 2: Edad vs cuantitativas")&
  theme(plot.caption = element_text(hjust = 0))
```
...
Modelaremos `enfermedad` como la respuesta de una regresión logística, matematicamente estamos diciendo que:
