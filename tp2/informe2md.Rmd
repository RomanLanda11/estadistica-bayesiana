...
muestras_2d <- sample_mh_2d(d_objetivo, r_propuesta, d_propuesta, p_inicial= c(1, 1), n=5000)
...
a <- 0.5
b <- 5
sigma_prop1 <- matrix(c(4,1,1,1), ncol = 2)
sigma_prop2 <- diag(2)
sigma_prop3 <- matrix(c(5,1,1,5), ncol = 2)
...
muestras_2d2 <- sample_mh_2d(d_objetivo, r_propuesta, d_propuesta, p_inicial= c(0, 1), n=5000)
...
muestras_2d1 <- sample_mh_2d(d_objetivo, r_propuesta, d_propuesta, p_inicial= c(0, 1), n=5000)
...
muestras_2d3 <- sample_mh_2d(d_objetivo, r_propuesta, d_propuesta, p_inicial= c(0, 1), n=5000)
