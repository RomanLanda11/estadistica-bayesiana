...
$$\Sigma_1=\begin{pmatrix}
   ...
   1 & 4
\end{pmatrix} $$
Las muestrar del primer postirior obtenidas resultan de la forma
```{r}
b1
```
...
$$\Sigma_2=\begin{pmatrix}
   ...
   0 & 1
\end{pmatrix} $$
Las muestrar del segundo postirior obtenidas resultan de la forma
```{r}
b2
```
...
$$\Sigma_3=\begin{pmatrix}
   ...
   -2 & 5
\end{pmatrix} $$
Las muestrar del tercer postirior obtenidas resultan de la forma
```{r, echo=FALSE}
b3
```
