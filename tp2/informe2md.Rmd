...
```
Consultar si tenemos que tantear distintos puntos de inicio por kappa
...
mu_prop <- c(0, 0)
sigma_prop <- diag(2)*0.2
#preguntar si lo puede recibir aca
...
df_grilla <- expand.grid(x = seq(-3, 6, length.out = 200), seq(-3, 3, length.out = 200))
...
ggplot(df, aes(x = V1, y = V2)) +
  ...
  geom_point(data = df, aes(x = V1, y = V2), color = "cyan2", alpha = 0.1) +
