...
\begin{center}
  ...
  \textbf{Alumnos:} Román Landa, Malena Irisarri, Simon Gazze\\
...
title(main = "Distribución Normal Multivariada")
```
...
# Graficar
persp(x, y, z, theta = 60, phi = 30, expand = 0.5, col = "lightblue",
      xlab = "X", ylab = "Y", zlab = "Z", ticktype = "detailed")
title(sub = "Función de Rosenbrock")
title(main = "Valle de Rosenbrock")
```
