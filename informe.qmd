...
r1
print(paste("La ganancia media por año es ",mean(ganancias1_df$ganacias),"unidades monetarias"))
...
```{r}
df_ganancias <- data.frame(Estrategia = rep(0:7,each=1000), Ganancia = c(ganacias0_df$ganacias, ganancias1_df$ganancias, ganancias2_df$ganancias, ganancia3_df$wins, ganancia4_df$wins, ganancia5_df$wins, ganancia6_df$wins, ganancia7_df$wins))
