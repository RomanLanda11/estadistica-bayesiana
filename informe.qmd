...
Se observa que la máquina más utilizada es la número dos presentando la mayor tasa de éxitos.
Viendo las distribuciones a posteriori se puede notar que las máquinas uno y tres están centradas alrededor del mismo valor, mientras que la máquina 2 está más concentrada alrededor de 0.55.
Con el último gráfico se observa la evolución de las ganancias a traves del paso de los días, obteniendo una ganancia total de 186 unidades monetarias.
